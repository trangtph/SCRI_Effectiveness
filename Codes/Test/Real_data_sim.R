...
covid_test_us_22 %>%
  ...
  scale_x_date(date_breaks = "4 weeks", date_labels = "%d %b") + 
  scale_y_continuous(n.breaks = 10)
ggsave("covid_dist_us_22.png", path = here("Plots", "Distribution"))
...
covid_vacc_us_22 %>%
  ...
  geom_line() +
  labs(x = "Day",
       y = "Daily probability of COVID-19 administration") +
  theme_bw() +
  scale_x_date(date_breaks = "4 weeks", date_labels = "%d %b") + 
  scale_y_continuous(n.breaks = 10)

ggsave("covid_vacc_us_22.png", path = here("Plots", "Distribution"))
