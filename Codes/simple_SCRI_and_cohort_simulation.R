...
### Functon for creating data based on Bernouilli per day approach
...
# Create group of 2000 individuals (1:1 exp-to-ctrls ratio) with 35 days of observations,
# with a weely probability of 0.05 of the outcome & vaccine effectiveness of 20%
s1  <- bin.days(4000, 35, 0.05, 0.20)
